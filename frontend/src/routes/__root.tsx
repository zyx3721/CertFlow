...
(function () {
  ...
  try {
    var theme = localStorage.getItem('certflow.zl-theme') === 'light' ? 'light' : 'dark';
    root.dataset.zlTheme = theme;
    root.style.colorScheme = theme;
  } catch (_) {
    root.dataset.zlTheme = 'dark';
...
function RootShell({ children }: { children: ReactNode }) {
  ...
  return (
    <html lang="zh-CN" data-zl-theme="dark" style={initialStyle} suppressHydrationWarning>
      <head>
